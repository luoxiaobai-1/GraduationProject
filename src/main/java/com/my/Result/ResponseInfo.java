...
import com.my.Constants.ResponseCodeEnums;
import lombok.Data;
...
public class ResponseInfo<T> {
    ...
    public static <T> ResponseInfo<T> SuccessWithData(T data) {
    ...
    public static <T> ResponseInfo<T> FailWithCode(ResponseCodeEnums CodeEnums,String message) {
        return new ResponseInfo<>(CodeEnums.FAIL.getCode(), message);
    }
